...
export default function LogoMarquee() {
  return (
    <section className="py-[60px] bg-white overflow-hidden select-none">
      <div className="w-full max-w-[1136px] mx-auto px-8 flex flex-col md:flex-row items-center gap-8">
