...
export default function Navigation() {
  ...
  return (
    <nav className={`sticky top-0 left-0 right-0 z-[100] transition-all duration-300 h-[72px] flex items-center ${scrolled ? 'backdrop-blur-lg bg-white/[0.03] border-b border-white/[0.08]' : 'bg-transparent border-b border-transparent'}`}>
      <div className="w-full max-w-[1120px] mx-auto px-[24px]">
